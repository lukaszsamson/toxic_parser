defmodule ToxicParser.ConformanceTest do
  @moduledoc """
  Conformance tests comparing ToxicParser output against `Code.string_to_quoted/2`.
  ...
  describe "grammar - empty input" do
    test "empty string" do
      ...
      assert {:ok, result} = ToxicParser.parse_string("")
      assert {:__block__, _, []} = result.ast
    end
  end
  ...
  describe "newlines" do
    ...
    test "repro 73" do
      assert_conforms("eggs eggs beta -89 do\n\n-> foo end")
    end
    ...
    test "repro 124" do
      assert_conforms("- beta alpha.bar, ..\n\n;... beta.\nbeta gamma +0")
    end
    ...
    test "repro 182" do
      assert_conforms("foo delta.foo;beta ((\ndelta.alpha, qux.beta, eggs) ->\n\nalpha\n;delta;-> alpha) - ... if")
    end

    test "repro 183" do
      assert_conforms(";foo ((beta: alpha.bar gamma.\n\nbaz, for) when beta.gamma -> qux.\ntry\n\n)[\ngamma: baz]")
    end
    ...
    test "repro 187" do
      assert_conforms(";& [beta,foo.delta,];bar (\n\n->\n\n), if\n\n;~~~ - ... \n\n... foo\n")
    end
  end
